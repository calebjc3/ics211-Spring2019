...
public class TranslatorTest {
  ...
  public final void testAsBinaryString() {
    String binary = fd.asBinaryString(new ByteArrayInputStream(byteArray));
    assertEquals("Got wrong binary String", binary, binaryData);
  }
  ...
  public final void testAsHexadecimalString() {
    String hex = fd.asHexadecimalString(new ByteArrayInputStream(byteArray));
    assertEquals("Got wrong hexadecimal String", hex, hexData);
  }
  ...
  public final void testAsUtf8String() {
    String utf8 = fd.asUtf8String(new ByteArrayInputStream(byteArray));
    assertEquals("Got wrong UTF-8 String", utf8, testData);
  }
